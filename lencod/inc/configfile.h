...
Mapping Map[] = {
    ...
    {"WaterMarkFile",            &cfgparams.wmfile,/*truongpt*/           1,   0.0,                       0,  0.0,              0.0,             FILE_NAME_SIZE, },  
    {"Threshold",                &cfgparams.threshold,                    0,   1.0,                       2, -1.0,              0.0,                             },
    {"InsertMode",               &cfgparams.insert_mode,                  0,   1.0,                       2, -1.0,              0.0,                             },
